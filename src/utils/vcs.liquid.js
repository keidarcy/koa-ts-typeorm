export const selectVariant = () => {
  const select1 = document.querySelector('.js-vcs-option-0');
  const select2 = document.querySelector('.js-vcs-option-1');
  const select3 = document.querySelector('.js-vcs-option-2');
  const price = document.querySelector('.js-vcs-price-1');
  const compareAtPrice = document.querySelector('.js-vcs-compare-price-1');
  const variantSelect = document.querySelector('.js-vcs-variant-select');
  const button = document.querySelector('button.js-vcs-button');
...
export const productCardAnimate = () => {
  const card = document.querySelector('.js-vcs-card');
